function u_new=LMPCcompute_uncons_analytical(R,X0,D,U,Ad,Bd,Bd_d,Czss,N,Q_cof,u_delta_cof)
% Syntax: u_new=LMPCcompute_analytical(R,Y,D,U,Ad,Bd,Bd_d,Czss,N,Q_cof,u_delta_cof)
