function u_new=LMPCcompute_inputcons(R,X0,D,U,Ad,Bd,Bd_d,Czss,u_min,u_max,u_delta_min,u_delta_max,N,Q_cof,u_delta_cof)
% Syntax: u_new=LMPCcompute_inputcons(R,X0,D,U,Ad,Bd,Bd_d,Czss,u_min,u_max,u_delta_min,u_delta_max,N,Q_cof,u_delta_cof)
