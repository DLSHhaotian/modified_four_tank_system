function s_yu=normal_steady_state_noise(y,u,ys,us,index_step,index_u)
[y_row,y_col]=size(y);
...
s_yu(1,1:index_step-1)=0;
s_yu(2,1:index_step-1)=0;
s_yu(3,1:index_step-1)=0;
s_yu(4,1:index_step-1)=0;
end